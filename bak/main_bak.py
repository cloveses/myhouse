...
class Ui_Learn_Train_Form(QWidget, Ui_Learn_Train_Form):   #第一个Ui_Learn_Train_Form名称可自定义，全篇统一即可；第二个Ui_Learn_Train_Form确定源于Learn_Train的class名
    ...
    def start_train(self):
        ...
        flags.DEFINE_integer('ps_tasks', 0,
                             ...
                             'a parameter server.')
        flags.DEFINE_string('train_dir', 'E:\\The_VideoInfor\\The_Main_Environment\\train\\ssd_mobilenet_v1_pets',
                            'Directory to save the checkpoints and training summaries.')

        flags.DEFINE_string('pipeline_config_path', 'E:\\The_VideoInfor\\The_Main_Environment\\models\\ssd_mobilenet_v1_pets\\ssd_mobilenet_v1_pets.config',
