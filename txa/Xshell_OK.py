...
if __name__ == '__main__':
    ...
    host.connect()
    host.send('cd GML1/rbs_test;bash test.sh') #自动录入命令执行
    print('-----------比对告警------------------' )
    host.send('cd /home/wfgch/GML1/rbs_test/LOG;grep ">>> Total:" *.log') #自动录入命令执行
    print('-----------查看小区状态------------------' )
    host.send('cd /home/wfgch/GML1/rbs_test/LOG;grep "ENodeBFunction=1,EUtranCellFDD" *.log') #自动录入命令执行
